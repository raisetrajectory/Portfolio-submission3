...
urlpatterns = [
    ...
    path('counselor_create_theme/', views.create_theme, name='create_theme'),
    path('list_themes/', views.list_themes, name='list_themes'),
    path('counselor_list_themes/', views.list_themes, name='list_themes'),
    ...
    path('counselor_delete_theme/<int:id>/', views.delete_theme, name='delete_theme'),
    path('post_comments/<int:theme_id>/', views.post_comments, name='post_comments'),
    path('counselor_post_comments/<int:theme_id>/', views.post_comments, name='post_comments'),
    ...
    path('counselor_comment/<int:comment_id>/delete/', views.delete_comment, name='comment_delete'),
    ...
    path('counselor_comment/<int:comment_id>/edit/', views.edit_comment, name='edit_comment'),
