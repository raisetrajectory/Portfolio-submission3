...
urlpatterns = [
    ...
    # path('counselor_create_theme/', views.create_theme, name='create_theme'), #不要となった場合は削除して大丈夫です！
    path('list_themes/', views.list_themes, name='list_themes'),
    # path('counselor_list_themes/', views.list_themes, name='list_themes'),#不要となった場合は削除して大丈夫です！
    path('edit_theme/<int:id>/', views.edit_theme, name='edit_theme'),
    # path('counselor_edit_theme/<int:id>/', views.edit_theme, name='edit_theme'),#不要となった場合は削除して大丈夫です！
    path('delete_theme/<int:id>/', views.delete_theme, name='delete_theme'),
    # path('counselor_delete_theme/<int:id>/', views.delete_theme, name='delete_theme'),#不要となった場合は削除して大丈夫です！
    path('post_comments/<int:theme_id>/', views.post_comments, name='post_comments'),
    # path('counselor_post_comments/<int:theme_id>/', views.post_comments, name='post_comments'),#不要となった場合は削除して大丈夫です！
    ...
    # path('counselor_comment/<int:comment_id>/delete/', views.delete_comment, name='comment_delete'),#不要となった場合は削除して大丈夫です！
    ...
    # path('counselor_comment/<int:comment_id>/edit/', views.edit_comment, name='edit_comment'),#不要となった場合は削除して大丈夫です！
