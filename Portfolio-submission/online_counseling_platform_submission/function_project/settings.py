...
# DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStorage' #203~205をコメントアウトすれば、再び画像が表示される様になります！
# MEDIA_URL = '/media/'
...
# DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.RawMediaCloudinaryStorage' #203~205をコメントアウトすれば、再び画像が表示される様になります！
# MEDIA_URL = '/media/'
# MEDIA_ROOT = BASE_DIR / 'media'
